    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('USR_RLS_Rol_Id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='FK_Usuarios_Roles_Rol_Id', to='Administrador.Roles')),
                ('USR_RLS_Usuario_Id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='FK_Usuarios_Roles_Usuario_Id', to='Administrador.Usuarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('USR_PRM_Permiso_Id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='FK_Usuarios_Permisos_Permiso_Id', to='Administrador.Permisos')),
                ('USR_PRM_Usuario_Id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='FK_Usuarios_Permisos_Usuario_Id', to='Administrador.Usuarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('MN_USR_Menu_Id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='FK_Menus_Usuarios_Menu_Id', to='Administrador.Menus')),
                ('MN_USR_Usuario_Id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='FK_Menus_Usuarios_Usuario_Id', to='Administrador.Usuarios')),
            ],
            options={
