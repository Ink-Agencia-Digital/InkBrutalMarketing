...
class UsuariosRoles(models.Model):
    ...
    USR_RLS_Usuario_Id = models.ForeignKey(Usuarios, on_delete = models.CASCADE, related_name='FK_Usuarios_Roles_Usuario_Id')
    USR_RLS_Rol_Id = models.ForeignKey(Roles, on_delete = models.CASCADE, related_name='FK_Usuarios_Roles_Rol_Id')
...
class MenusUsuarios(models.Model):
    MN_USR_Id = models.BigAutoField(primary_key = True)
    MN_USR_Menu_Id = models.ForeignKey(Menus, on_delete = models.CASCADE, related_name='FK_Menus_Usuarios_Menu_Id')
    MN_USR_Usuario_Id = models.ForeignKey(Usuarios, on_delete = models.CASCADE, related_name='FK_Menus_Usuarios_Usuario_Id')
...
class UsuariosPermisos(models.Model):
    USR_PRM_Id = models.BigAutoField(primary_key = True)
    USR_PRM_Usuario_Id = models.ForeignKey(Usuarios, on_delete = models.CASCADE, related_name='FK_Usuarios_Permisos_Usuario_Id')
    USR_PRM_Permiso_Id = models.ForeignKey(Permisos, on_delete = models.CASCADE, related_name='FK_Usuarios_Permisos_Permiso_Id')
